...
export const interiorStyles: InteriorStyle[] = [
  {
    ...
    galleryImages: [
      ...
      "/styles/minimalism/kitchen.png",
      "/styles/minimalism/bathroom.png"
    ],
    bgColor: "#0D0D0D",
    isDark: true,
  },
  {
    ...
    galleryImages: [
      ...
      "/styles/scandinavian/kitchen.png",
      "/styles/scandinavian/bathroom.png"
    ],
    bgColor: "#1D242B",
    isDark: true,
  },
  ...
  },
  {
    ...
    galleryImages: [
      "/styles/bohemian/living.png",
      "/styles/bohemian/bedroom.png"
    ],
    bgColor: "#42523C",
    isDark: true,
  },
  {
    ...
    galleryImages: [
      "/styles/mid-century/living.png",
      "/styles/mid-century/bedroom.png"
    ],
    bgColor: "#7A412A",
    isDark: true,
  },
  {
    ...
    galleryImages: [
      "/styles/biophilic/living.png",
      "/styles/biophilic/bedroom.png"
    ],
    bgColor: "#142F2F",
    isDark: true,
  },
  {
    ...
    galleryImages: [
      "/styles/cozy/living.png",
      "/styles/cozy/bedroom.png"
    ],
    bgColor: "#24201E",
    isDark: true,
  },
