...
export const interiorStyles: InteriorStyle[] = [
  ...
  },
  {
    ...
    galleryImages: [
      "/styles/all-styles/french-modern_wide1.jpeg",
      "/styles/all-styles/french-modern_wide2.jpeg",
      "/styles/all-styles/french-modern_wide3.jpeg",
      "/styles/all-styles/french-modern_wide4.jpeg",
      "/styles/all-styles/french-modern_wide5.jpeg",
      "/styles/all-styles/french-modern_wide6.jpeg",
      "/styles/all-styles/french-modern_wide7.jpeg"
    ],
    bgColor: "#3A362F",
    isDark: true,
    isNew: true,
  },
  {
    ...
    galleryImages: [
      "/styles/all-styles/coastal_wide1.jpeg",
      "/styles/all-styles/coastal_wide2.jpeg",
      "/styles/all-styles/coastal_wide3.jpeg",
      "/styles/all-styles/coastal_wide4.jpeg",
      "/styles/all-styles/coastal_wide5.jpeg",
      "/styles/all-styles/coastal_wide6.jpeg",
      "/styles/all-styles/coastal_wide7.jpeg",
      "/styles/all-styles/coastal_wide8.jpeg"
    ],
    bgColor: "#1E2A30",
    isDark: true,
    isNew: true,
  },
  {
    ...
    galleryImages: [
      "/styles/all-styles/organic-modern_wide1.jpeg",
      "/styles/all-styles/organic-modern_wide2.jpeg",
      "/styles/all-styles/organic-modern_wide3.jpeg",
      "/styles/all-styles/organic-modern_wide4.jpeg",
      "/styles/all-styles/organic-modern_wide5.jpeg",
      "/styles/all-styles/organic-modern_wide6.jpeg"
    ],
    bgColor: "#2B2620",
    isDark: true,
    isNew: true,
  },
  {
    ...
    galleryImages: [
      "/styles/all-styles/maximalism_wide1.jpeg",
      "/styles/all-styles/maximalism_wide2.jpeg",
      "/styles/all-styles/maximalism_wide3.jpeg",
      "/styles/all-styles/maximalism_wide4.jpeg",
      "/styles/all-styles/maximalism_wide5.jpeg",
      "/styles/all-styles/maximalism_wide6.jpeg",
      "/styles/all-styles/maximalism_wide7.jpeg",
      "/styles/all-styles/maximalism_wide8.jpeg"
    ],
    bgColor: "#1F3B2E",
    isDark: true,
    isNew: true,
  },
  {
    ...
    galleryImages: [
      "/styles/all-styles/modern-hanok_wide5.jpeg",
      "/styles/all-styles/modern-hanok_wide1.jpeg",
      "/styles/all-styles/modern-hanok_wide2.jpeg",
      "/styles/all-styles/modern-hanok_wide3.jpeg",
      "/styles/all-styles/modern-hanok_wide4.jpeg",
      "/styles/all-styles/modern-hanok_wide6.jpeg"
    ],
    bgColor: "#2E2A20",
    isDark: true,
    isNew: true,
